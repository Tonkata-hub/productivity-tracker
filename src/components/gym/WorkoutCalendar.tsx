...
import { ChevronLeft, ChevronRight, Loader2, Clock, Dumbbell, TrendingUp, X, Trash2, AlertTriangle } from 'lucide-react'
                ...
                <div key={day} className="flex flex-col items-center justify-center h-12">
                  <button
                    ...
                    className={cn(
                      ...
                      !todayDay && hasW && [
                        'text-white/90 hover:bg-white/8 active:bg-white/12 cursor-pointer',
                      ],
                  ...
                  <div>
                    ...
                    {sheetWorkout && (
                      <>
                        ...
                        <p className={cn('mt-0.5', sheetWorkout.name ? 'text-xs text-muted-foreground' : 'text-base font-semibold text-foreground')}>
